...
@Component({
  selector: 'app-dialog-create-work',
  templateUrl: './dialog-create-work.component.html',
  styleUrls: ['./dialog-create-work.component.scss']
})
export class DialogCreateWorkComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<DialogCreateWorkComponent>,
  ...
  onSubmit(){
    if(this.createWorkForm.valid){
      ...
      formData.append("parentWorkId", this.data.parentWorkId);
      ...
      this.workService.createWork(formData)
        .subscribe({
          next: (res: any) => {
            //console.log(res);
